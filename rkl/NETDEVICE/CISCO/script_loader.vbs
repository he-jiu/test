...
' 文件修改名称
		resultFileN = currentPath & "\" & RESULT_FOLDER & "\" & destRealIpPath & "_" &  currentDatetime() & RESULT_FILE_EXTENSION
    ...
    Private Function execScriptLine(line, execFlag, resultFile, resultFileObject, prompt)
        ...
        Else
            ...
            If Len(line) > 0 Then
                ...
                currentScreen.WaitForString line, 1		
                currentScreen.Send vbCrLf
                echoMore = currentScreen.WaitForStrings(prompt, MORE_PROMPT, 1)
                If echoMore = 2 Then
                    Do While echoMore = 2
